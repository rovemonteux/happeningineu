  ...
  unless str.nil? or !str.include? 'map'
    vurl= str.match(/^map:.*$/ix)
      unless vurl.nil?
        ...
        embed = "<img height=\"315\" width=\"560\" src=\"https://maps.googleapis.com/maps/api/staticmap?center="+embedurl+"&zoom=13&size=672x378&maptype=hybrid&sensor=false\" class=\"map\"/><br/><br/><img height=\"315\" width=\"560\" src=\"https://maps.googleapis.com/maps/api/staticmap?center="+embedurl+"&zoom=15&size=672x378&maptype=hybrid&sensor=false\" class=\"map\"/><br/><br/><img height=\"315\" width=\"560\" src=\"https://maps.googleapis.com/maps/api/staticmap?center="+embedurl+"&zoom=17&size=672x378&maptype=hybrid&sensor=false\" class=\"map\"/><br/><div style=\"width:560px; margin-top: -5px; margin-bottom: 25px;\"><span style=\"font-size: 9px; float: right; position: relative; margin-top: -5px; margin-bottom: -40px; \"><a href=\"https://maps.google.com/?q="+embedurl+"\" target=\"_blank\" rel=\"nofollow\">"+originalurl.strip.titleize+"</a></span></div>"
        begin
