...
jQuery.fn.jmp3 = function(passedOptions){
	// hard-wired options
	var playerpath = "/javascripts/";					// SET THIS FIRST: path to singlemp3player.swf

	// passable options
	var options = {
		"filepath": "",										// path to MP3 file (default: current directory)
		"backcolor": "ffffff",									// background color
		"forecolor": "cacaca",								// foreground color (buttons)
		"width": "560",										// width of player
		"repeat": "no",										// repeat mp3?
		"volume": "95",										// mp3 volume (0-100)
